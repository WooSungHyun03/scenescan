...
5. Run `pnpm lint`, `pnpm typecheck`, `pnpm test`, `pnpm build`, and `pnpm docker:build` before a PR. GitHub Actions repeats these gates in Docker and smoke-tests `/api/health` plus the primary pages.
